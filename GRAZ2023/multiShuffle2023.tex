...
\item The $Q+1$ transformation: \blue{${\mathcal F}_\gamma(\Qvar;\Zvar)=\overline{{\mathcal E}_\gamma(\Qvar+1;\Zvar)}$}, $s\otimes e$--positivity conjecture and the stabilization for $n$. 
...
where $\sigma_{\mu}(\Qvar)$ is schur positive. We conjecture many properties of the $ \sigma_{\mu}(\Qvar)$. Some of the property are derived from the module of harmonics we expect behind these symmetric functions. [we talk about polarization in particular].

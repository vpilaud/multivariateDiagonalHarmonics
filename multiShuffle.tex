...
The anklet~$\ank({\bf c})$ of a Hopf chain~${\bf c} = (c_1, \dots, c_r)$ (where~$c_1$ is the staircase path) is the maximal number of paths that can be inserted between the first two paths~$c_1$ and~$c_2$ of the chain~${\bf c}$ so that it remains a Hopf chain.
